...
async def test(page: Page):
    ...
    element_pw = page.locator("[data-test=\"password\"]")
    await element_pw.click()
    await element_pw.fill("secret_sauce")
    ...
    # Assertion check
    await pw_expect(page.get_by_text('Remove', exact=False)).to_be_visible()
